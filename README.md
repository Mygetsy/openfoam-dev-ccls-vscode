...
This repository provides a ready-to-use VS Code Dev Container setup for OpenFOAM solvers development with `ccls` indexing and an integrated build workflow. This allows to have syntax highlight of source code and your application code.
